...
AUTO_GENERATE_SHOW_PROMPT = True
LLM_VERIFY_MODEL: str | None = None
LLM_BOUNDARY_REFINE_MODEL: str | None = None
ENABLE_TWO_STAGE_CLASSIFY = False
TWO_STAGE_EDGE_PREROLL_SECONDS = 120
TWO_STAGE_EDGE_OUTRO_SECONDS = 60
TWO_STAGE_CANDIDATE_PAD_SEGMENTS = 5
ENABLE_AD_AUDIO_FINGERPRINT = True
AD_AUDIO_FP_MATCH_THRESHOLD = 0.15
AD_AUDIO_FP_MIN_DURATION_SECONDS = 3.0
ENABLE_AD_GAP_DETECTION = False
AD_GAP_MIN_SECONDS = 4.0
AD_GAP_NOISE_DB = -30
ENABLE_AD_GAP_AUTO_CUT = False
JINGLE_MIN_SECONDS = 1.0
JINGLE_MAX_SECONDS = 15.0
AD_CREATIVE_MIN_CHARS = 24
AD_CREATIVE_JACCARD = 0.85
...
OUTPUT_MIN_AD_SEGMENT_LENGTH_SECONDS = 5
OUTPUT_MIN_CONFIDENCE = 0.7
